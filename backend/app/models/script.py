...
class Script(Base):
    ...
    is_analyzed = Column(Boolean, default=False, comment="Analysis completed")
    status = Column(String(50), default="uploaded", comment="Analysis status: uploaded/parsing/analyzing_roles/tagging_emotions/completed/failed")
